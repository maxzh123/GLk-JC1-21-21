    ...
    * */
    ...
    private static boolean isPrime(int number){
        if (number==0 || number==1 || number==2){ //Если число которое нам передали одно из 0 1 2
            ...
            for(int i=2;i<=Math.sqrt(number);i++){//для целочисленного i установить значение 2;выполнять блок пока i меньше (number+1/2); после каждого исполнения увеличить i на 1
                count++;
